...
const textParagraphs: TextParagraphs = [
  {
    isStrong: true,
    content: `
      Mandager fra kl. 16:00 - 19:00 vil barne- og ungdomsskoleelever
  ...
  },
  {
    isStrong: false,
    content: `
      På leksehjelpen vil det bli servert varm mat før deltakerne begynner
      med leksene. Vi har alltid vegetarmat eller vegetaralternativer.
      Dette ser vi på som viktig både for sosialisering, inkludering
      og for å øke fokuset på leksene. Etter alle er ferdig med ukens
      lekser, arrangerer vi noen felles aktiviteter som bingo, Kahoot,
      quiz, kortspill eller annet frem til aktiviteten er ferdig.
      `,
  },
];
