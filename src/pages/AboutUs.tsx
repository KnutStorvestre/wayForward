        ...
        <div>
          <div className="text-container">
            ...
            <p className={styles.mainParagraph}>
              ...
              det norske samfunnet med et ekstra fokus på at jenter skal delta i
              like stor grad som guttene. Organisasjonen ble startet av Richard
              Kiwanuka i 2004 og bruker nå leksehjelp, sykkelverksted,
              musikkstudio, jentegruppe og andre fritidsaktiviteter for å nå
              sine mål. Way Forward har et høyt fokus på å bygge opp et samfunn
              hvor alle har muligheten til å delta i sosiale aktiviteter uansett
